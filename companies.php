...
{	
	...
	{
	$sqlupd = mysqli_query($con,"UPDATE companies SET CompanyInfo='$AboutCompany',CompanyName='$companyname',Address='$Address',EmailId='$_POST[E_mailID]',ContactNo='$_POST[ContactNo]',CompanyLogo='$filename',Website='$_POST[Website]',Status='$_POST[Status]' WHERE CompanyId='$_GET[editid]'");
	...
	{
		$sqlins = mysqli_query($con,"INSERT into companies(CompanyInfo,CompanyName,Address,EmailId,ContactNo,CompanyLogo,Website,Status)VALUES('$AboutCompany','$companyname','$Address','$_POST[E_mailID]','$_POST[ContactNo]','$filename','$_POST[Website]','$_POST[Status]')");
					if(!$sqlins)
			{
...
?>
		<script>
		alert("Company Information inserted successfully...");
		</script>
<?php
			}
	}
...
if(isset($_GET['editid']))
{
$sqlst = mysqli_query($con,"SELECT * FROM companies WHERE CompanyId='$_GET[editid]'");
