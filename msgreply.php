...
function validate()
{
	...
	else if(document.form1.message.value=="")
	{
		...
		return false;
				...
				{
					$sqlins = mysqli_query($con,"INSERT into reply(name,email,subject,message, status)VALUES('$_POST[name]','$_POST[email]','$_POST[subject]','$_POST[message]','Enabled')");
					if(!$sqlins)
			{
...
?>
		<script>
		alert("Mail sent successfully to the Student!!");
		</script>
<?php
			}
			}
...
?>             
  ...
  <div class="col-xs-12 col-sm-6 col-lg-8">
            <h2>Reply the Students Questions!!</h2>
            <p>
